	...
	public static IEnumerator MoveTo(Transform transform, Vector3 target, float time, Axis scaleAxes, Space space, Action onEnd, Settings settings)
	{
		...
		var coroutine = Base(
			...
			action: newPositions =>
			{
				...
				switch(scaleAxes)
				{
					case Axis.ALL:	position = newPositions;													break;

					case Axis.X:	position = new Vector3(newPositions.x, position.y, position.z);	break;
					case Axis.Y:	position = new Vector3(position.x, newPositions.y, position.z);	break;
					case Axis.Z:	position = new Vector3(position.x, position.y, newPositions.z);	break;

					case Axis.XY:	position = new Vector3(newPositions.x, newPositions.y, position.z);	break;
					case Axis.XZ:	position = new Vector3(newPositions.x, position.y, newPositions.z);	break;
					case Axis.YZ:	position = new Vector3(position.x, newPositions.y, newPositions.z);	break;
				}
	...
	public static IEnumerator ScaleTo(
		...
		var coroutine = Base(
			...
			action: newScale => {
				...
				switch(scaleAxes)
				{
					case Axis.ALL:	scale = newScale;												break;

					case Axis.X:	scale = new Vector3(newScale.x, scale.y, scale.z);	break;
					case Axis.Y:	scale = new Vector3(scale.x, newScale.y, scale.z);	break;
					case Axis.Z:	scale = new Vector3(scale.x, scale.y, newScale.z);	break;

					case Axis.XY:	scale = new Vector3(newScale.x, newScale.y, scale.z);		break;
					case Axis.XZ:	scale = new Vector3(newScale.x, scale.y, newScale.z);		break;
					case Axis.YZ:	scale = new Vector3(scale.x, newScale.y, newScale.z);		break;
				}
	...
	public static IEnumerator Rotate(Transform transform, Vector3 target, float time, Axis scaleAxes, Space space, Action onEnd, Settings settings)
	{
		...
		var coroutine = Base(
			...
			action: newAngles =>
			{
				...
				switch(scaleAxes)
				{
					case Axis.ALL:	angles = newAngles;													break;

					case Axis.X:	angles = new Vector3(newAngles.x, startAngles.y, startAngles.z);	break;
					case Axis.Y:	angles = new Vector3(startAngles.x, newAngles.y, startAngles.z);	break;
					case Axis.Z:	angles = new Vector3(startAngles.x, startAngles.y, newAngles.z);	break;

					case Axis.XY:	angles = new Vector3(newAngles.x, newAngles.y, startAngles.z);	break;
					case Axis.XZ:	angles = new Vector3(newAngles.x, startAngles.y, newAngles.z);	break;
					case Axis.YZ:	angles = new Vector3(startAngles.x, newAngles.y, newAngles.z);	break;
				}
